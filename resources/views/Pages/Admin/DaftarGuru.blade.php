...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <a href="{{ route('addGuru') }}" class="btn btn-primary btn-sm mb-4">
            Tambah Data
        </a>
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-3">{{ $g->email }}</td>
                        <td class="col-3">
                            <center>
                                <a href="/admin/edit-guru/{{ $g->id }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Ubah</a>
                                <form action="/admin/delete-guru/{{ $g->id }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
