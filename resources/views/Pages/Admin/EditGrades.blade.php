        ...
        <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="/admin/update-daftar-tingkatan/{{ Crypt::encrypt($grade->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control mt-3 @error('grades')
                                        is-invalid
                                    @enderror " placeholder="Masukkan Tingkatan" autofocus value="{{ $grade->grade }}" name="grades">
