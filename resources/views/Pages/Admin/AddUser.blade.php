...
<h1 class="h3 mb-2 text-secondary text-center">Tambah Pengguna</h1>
    ...
    <div class="row justify-content-center mt-4">
        <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('user') }}" class="btn btn-warning btn-sm mb-4">Kembali</a>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control mt-3 @error('name')
                                        is-invalid
                                    @enderror " placeholder="Masukkan Nama Pengguna" aria-label="Username" aria-describedby="basic-addon1" autofocus value="{{ old('name') }}" name="name">
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    is-invalid
                                @enderror" placeholder="Masukkan Email Pengguna" aria-label="Username" aria-describedby="basic-addon1" value="{{ old('email') }}" name="email">
