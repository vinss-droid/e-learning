...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
            @include('Pages.Layout.Dashboard.Sidebar')
        <!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                    @include('Pages.Layout.Dashboard.Topbar')
                <!-- End of Topbar -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; vinss-droid.com {{ date("Y") }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{ asset('dashboard/vendor/jquery-easing/jquery.easing.js') }}"></script>
    ...
    <script>
        ...
        function time() {
            ...
            clock.innerHTML = 
            '<i class="fa-solid fa-clock"></i> ' + ("0" + h).substr(-2) + ":" + ("0" + m).substr(-2) + ":" + ("0" + s).substr(-2) + " " + am_pm;
        }
